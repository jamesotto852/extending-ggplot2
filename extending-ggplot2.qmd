...
before it goes to the `$draw_*()` hierarchy

::: {.fragment}

* This is of limited use and is generally only appropriate
...
# p5 <- ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = species)) +
#   geom_point() +
#   ggforce::facet_zoom(x = Species == "Chinstrap")

# p6 <- ggplot(geofacet::state_unemp, aes(year, rate)) +
#   geom_line() +
...
aligned_plots <- align_patches(p1, p2, p3, p4, p5, p6, p7)
```
...
## {data-menu-title="Package Development 1"}
