...
<!-- ## `GeomComplete$draw_group()` -->

<!-- Technically, we haven't implemented `GeomComplete` correctly: -->
...
<!-- ggplot(df_simple, aes(x, y, color = class)) + -->
<!--   geom_point(size = 5) + -->
<!--   geom_complete() -->
<!-- ``` -->

<!-- ## {data-menu-title="GeomComplete$draw_group() 1"} -->
...
<!-- ## {data-menu-title="GeomComplete$draw_group() 2"} -->
